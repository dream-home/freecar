...
/* 105:    */   }
    ...
    /*  88:    */public void walletpassphrase (String password)
/*  89:    */   {
/*  90:140 */     if (password == null) {
/*  91:141 */       password = "qwertyui123456789";
/*  92:    */     }
/*  93:    */     try
/*  94:    */     {
/*  95:145 */       JSONArray parameters = new JSONArray().element(password).element (10);
/*  96:146 */       JSONObject request = createRequest("walletpassphrase", parameters);
                    this.session.sendAndReceive(request);
/* 100:    */     }
/* 101:    */     catch (JSONException e)
/* 102:    */     {
/* 103:151 */       throw new BitcoinClientException("Exception when walletpassphrase  ", e);
/* 104:    */     }
/* 105:    */   }
