...
public class RedisServiceImpl implements RedisService {
	...
	@Override
	public boolean redisLock(String key, String value, int seconds) {
		Object vo =  this.getString(key);
		if (vo==null){
			this.putString(key, value,seconds);
			return true;
		}
		return false;
	}
