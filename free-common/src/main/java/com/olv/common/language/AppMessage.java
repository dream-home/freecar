package com.olv.common.language;
...
public class AppMessage {
     ...
     * 登录已失效
     */
    public static String LOGIN_HAS_EXPIRED = "login_has_expired";
    /**
     * 用户已激活
     */
     ...
     * 新旧支付密码不能一致
     */
    public static String NEW_OLD_ERROR = "new_old_error_pay_error";
    /**
     * 新旧登录密码不能一致
     */
    public static String NEW_OLD_ERROR_LOGIN_ERROR = "new_old_error_login_error";
    /**
     * 支付密码错误
     */
     ...
     *每天最大提现笔数为
     */
    public static String NUMBER_PER_DAY = "number_per_day";
    /**
     *银行卡id不能为空
     */
     ...
     * 收款人手机最后四位号码错误
     * */
    public static final String PAYEE_PHONE_INVAIL = "payee_phone_invail";
    /**
     * 加载个人消息列表失败
     * */
    public static final String LOAD_MESSAGE_FAIL="load_message_fail";
    /**
     * 加载个人消息总数失败
     * */
    public static final String LOAD_MESSAGE_COUNT_FAIL="load_message_count_fail";
    /**
     * 钱包扣款失败
     */
    public static final String COIN_DEBIT_FAIL = "coin_debit_fail";
    /**
     * 输入钱包地址无效
     */
    public static final String COIN_ADDRESS_INVAIL = "coin_address_invail";
    /**
     * 请求失效
     */
    public static final String GET_USERINFO_FAIL= "get_userinfo_fail";
    /**
     * 转账成功
     */
     ...
     * 查询权限不够
     */
    public static String INSUFFICIENT_PERMISSIONS = "insufficient_permissions";
}
