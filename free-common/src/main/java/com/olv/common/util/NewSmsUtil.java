...
import com.olv.common.enums.LanguageEnum;
...
public class NewSmsUtil {
	...
	public void sendSmsByEN(String mobile, String contact, String templateId) throws Exception{
		try{
			...
			LogUtils.error("000000000000000000000000000000000000000000000");
			LogUtils.error(mobile);
			LogUtils.error(contact);
			LogUtils.error(templateId);
			LogUtils.error("000000000000000000000000000000000000000000000");
			String content=templateId.replaceAll("\\{1\\}",contact);
	...
	public static void main(String[] args) {
		String templateId="Your verification code is {1}. Please ignore this message if you are not doing it by yourself.【波罗芬】";
		String mobile="0085569581243";
		String contact="0000";

//		sms.cn_sn=SDK-FLH-010-00275
//		sms.cn_password=95##c#-7
//		sms.en_sn=SDK-FLH-010-00278
//		sms.en_password=5006f7$0
//		sms.ext=3

		String content=templateId.replaceAll("\\{1\\}",contact);
		List<String> enUrls=new ArrayList();
		enUrls.add("http://sdk.entinfo.cn:8060/gjwebservice.asmx/mdSmsSend_g");
		String pwd=CryptUtils.getMD5("SDK-FLH-010-00278" +"5006f7$0");
		for(String url : enUrls){
			String rrid = ToolUtils.getOrderNo();
			String rs= HttpUtils.sendPost(url,"sn=SDK-FLH-010-00278&pwd="+pwd+"&mobile="+mobile+"&content="+content+"&ext=2&stime=&rrid="+rrid+"&msgfmt=");
